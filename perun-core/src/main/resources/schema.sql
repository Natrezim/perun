...
create sequence groups_operation_id_seq;
...
alter table groups_operations add constraint groups_operation_pk primary key (operation_id);
alter table groups_operations add constraint groups_operation_name_u unique (name);
alter table groups_groups add constraint groups_groups_pk primary key (result_gid, operand_gid);
alter table groups_groups add constraint groups_operation_id_fk foreign key (operation_id) references groups_operations;
